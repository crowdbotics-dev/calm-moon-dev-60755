"""
Django settings for calm_moon_dev_60755 project.
...
ROOT_URLCONF = 'calm_moon_dev_60755.urls'
...
WSGI_APPLICATION = 'calm_moon_dev_60755.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_moon_dev_60755 API",
    "DESCRIPTION": "API documentation for calm_moon_dev_60755 App",
    "VERSION": "v1",
}
